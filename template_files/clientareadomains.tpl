        ...
        <tr>
            ...
            <td>
                ...
                <ul class="dropdown-menu">
                    {if $domain.managens}<li><a href="clientarea.php?action=domaindetails&id={$domain.id}#tab3"><span class="glyphicon glyphicon-globe"></span> {$LANG.domainmanagens}</a></li>{/if}
